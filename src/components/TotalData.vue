...
<template>
	<dv-border-box11 title="全国年度网络数据可视化统计" :title-width="400" :animate="false">
	<div class="p-6 mt-40 pt-20">
		...
		<div class="mt-3 flex flex-wrap   pt-5">
			...
			<div class="w-1/3 text-center text-slate-400 text-sm pt-5">
				中南：<span
					ref="city4"
					class="text-[#5DC5EF] text-3xl font-[Electronic]"
					>8,778,988</span
